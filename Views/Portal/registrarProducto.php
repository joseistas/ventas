...
<div class="row mt-5">
    ...
    <div class="col-md-8 bg-white shadow">
        ...
        ?>
        <h3 class="text-center mt-4 mb-3">Registro Producto</h3>
        <form action="../../Controller/ProductoController.php" method="POST">
            ...
            <div class="form-row my-3">
                ...
                <div class="col-md-10 form-group">
                    ...
                    <input id="nombre" name="nombre" type="text" class="form-control" placeholder="Nombre Producto" required>
                </div>
                <div class="col-md-1"></div>
            </div>
            <div class="form-row">
                ...
                <div class="col-md-5 form-group">
                    ...
                    <input type="number" id="precio" name="precio" class="form-control" placeholder="Precio Unitario" required>
                </div>
                <div class="col-md-5 form-group">
                    <label for="cantidad">Cantidad Disponible (*)</label>
                    <input id="cantidad" name="cantidad" type="number" class="form-control" placeholder="Cantidad disponible" required>
                </div>
                <div class="col-md-1"></div>
            </div>
            <div class="form-row my-3"> 
